...
const products: Product[] = [
  ...
  {
    id: 9,
    name: 'Nike Air Jordan Retro 1 - Chicago',
    price: 179,
    originalPrice: 220,
    image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&h=300&fit=crop',
    rating: 4.6,
    ...
    discount: 19,
    description: 'Classic Nike Air Jordan Retro 1 in iconic Chicago colorway. Premium leather construction.',
    specifications: ['Premium Leather', 'Air Cushioning', 'Rubber Outsole', 'Classic Design'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Nike Store',
    location: 'Beaverton, OR',
  ...
  },
  {
    ...
    badge: 'Best Value',
    discount: 19,
    description: '65-inch Neo QLED 4K Smart TV with Quantum HDR and premium design.',
    specifications: ['65" Neo QLED', '4K Resolution', 'Quantum HDR', 'Smart TV Features'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Samsung Store',
  ...
  },
  {
    ...
    specifications: ['Laser Detection', 'Up to 60 min runtime', 'Advanced Filtration', 'Multiple Attachments'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Dyson Store',
    location: 'Malmesbury, UK',
  ...
  },
  {
    ...
    badge: 'Luxury',
    discount: 17,
    description: 'Iconic YSL Libre fragrance with floral and woody notes in elegant bottle.',
    specifications: ['50ml Bottle', 'Floral & Woody Notes', 'Long-lasting', 'Luxury Packaging'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'YSL Beauty',
  ...
  },
  {
    ...
    badge: 'Pro Level',
    discount: 21,
    description: 'Professional tennis racket used by top players worldwide.',
    specifications: ['Carbon Fiber Frame', 'Pro String Pattern', '315g Weight', 'Professional Grip'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Wilson Sports',
    location: 'Chicago, IL',
  ...
  },
  {
    ...
    badge: 'Trending',
    discount: 25,
    description: 'Luxurious velvet sofa with modern design and premium comfort.',
    specifications: ['Premium Velvet', '3-Seater', 'Hardwood Frame', 'Memory Foam Cushions'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Modern Home',
  ...
  },
  {
    ...
    badge: 'Hot Deal',
    discount: 13,
    description: 'PlayStation 5 console with DualSense controller and exclusive games.',
    specifications: ['PS5 Console', 'DualSense Controller', 'Ultra HD Blu-ray', '825GB SSD'],
    shipping: 'Free shipping',
    condition: 'New',
  ...
  },
  {
    ...
    badge: 'Professional',
    discount: 15,
    description: 'Professional mirrorless camera with advanced image stabilization.',
    specifications: ['24.2MP Full-Frame', '8K Video', 'Image Stabilization', 'Dual Card Slots'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Canon Store',
    location: 'Tokyo, Japan',
  ...
  },
  {
    ...
    specifications: ['Boost Midsole', 'Primeknit Upper', 'Continental Rubber', 'Energy Return'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Adidas Store',
  ...
  },
  {
    ...
    badge: 'Iconic',
    discount: 19,
    description: 'The world\'s most iconic fragrance in elegant crystal bottle.',
    specifications: ['50ml Bottle', 'Timeless Fragrance', 'Luxury Packaging', 'Long-lasting'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Chanel Beauty',
    location: 'Paris, France',
    timeLeft: '3 days left'
  },
  {
    ...
    badge: 'Classic',
    discount: 18,
    description: 'Original straight-fit jeans with authentic vintage wash.',
    specifications: ['100% Cotton', 'Straight Fit', 'Button Fly', 'Classic 5-pocket'],
    shipping: 'Free shipping',
    condition: 'New',
    seller: 'Levi\'s Store',
...
const categories = [
  { name: 'Electronics', count: 1250, color: 'bg-blue-500', image: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=300&h=200&fit=crop' },
  { name: 'Fashion', count: 890, color: 'bg-pink-500', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=300&h=200&fit=crop' },
  { name: 'Home & Garden', count: 650, color: 'bg-green-500', image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=300&h=200&fit=crop' },
  { name: 'Sports', count: 420, color: 'bg-orange-500', image: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=300&h=200&fit=crop' },
  { name: 'Beauty', count: 380, color: 'bg-purple-500', image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=300&h=200&fit=crop' },
  { name: 'Books', count: 290, color: 'bg-yellow-500', image: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=300&h=200&fit=crop' }
]
