          ...
          <div className="hidden sm:flex flex-1 max-w-md mx-2 sm:mx-8">
            <div className="relative w-full">
              <input
                ...
                className="w-full px-3 sm:px-4 py-2 sm:py-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm text-sm sm:text-base"
              />
